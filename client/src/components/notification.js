...
export const successMsg = (msg, id) => {
    iziToast.success({ id: id, position: msgPos, message: msg, displayMode: 0 });
}
...
export const warningMsg = (msg, id) => {
...
export const Msg = {
    ...
    UNLOCK_TOKEN_SUCCESS: "Your JNTR unlocked successfully!",
    UNLOCK_TOKEN_FAILED: "Error while unlocking your tokens!",
    UNLOCK_TOKEN_DENIED: "You can unlock your JNTR after auction ends",
    CANCEL_INVESTMENT_SUCCESS: "Investment canceled successfully!",
    CANCEL_INVESTMENT_FAILED: "Error while canceling your investment!",
    CANCEL_INVESTMENT_DENIED: "You can cancel investment after auction ends",
}
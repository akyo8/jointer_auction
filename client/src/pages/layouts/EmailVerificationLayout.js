...
export default class EmailVerificationLayout extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Helmet>
                    <title>Jointer - Email Verification</title>
                    ...
                    <link rel="stylesheet" type="text/css" href={CONSTANT.PrePath + "/css/email_verification_css/jquery.mCustomScrollbar.css?v=1.4"} />
                    <link rel="stylesheet" type="text/css" href={CONSTANT.PrePath + "/css/email_verification_css/flags.css?v=1.5"} />
                    <link href="https://cdnjs.cloudflare.com/ajax/libs/izimodal/1.5.1/css/iziModal.min.css" rel="stylesheet" type="text/css" />
                    <link rel="stylesheet" type="text/css" href={CONSTANT.PrePath + "/css/email_verification_css/user-style.css?v=1.5"} />
